...
public class CsvAggregateDataPointsIteratorM4 implements Iterator<AggregatedDataPoint> {

    private static final Logger LOG = LoggerFactory.getLogger(CsvAggregateDataPointsIteratorM4.class);
    ...
    public CsvAggregateDataPointsIteratorM4(
