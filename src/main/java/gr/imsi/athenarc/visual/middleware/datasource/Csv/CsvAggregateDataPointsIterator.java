...
public class CsvAggregateDataPointsIterator implements Iterator<AggregatedDataPoint> {

    private static final Logger LOG = LoggerFactory.getLogger(CsvAggregateDataPointsIterator.class);
    ...
    public CsvAggregateDataPointsIterator(
    ...
    private class MeasureAggregationState {
        ...
        private NonTimestampedStatsAggregator aggregator;
        ...
        boolean moveToNextInterval(long timestamp) {
            ...
            while (currentIntervalIndex < intervals.size()) {
                ...
                if (currentInterval.getTo() > timestamp) {
                    ...
                    aggregator = new NonTimestampedStatsAggregator();
                    aggregator.setFrom(currentSubIntervalStart);
                    aggregator.setTo(currentSubIntervalEnd);
                    return true;
                }
                currentIntervalIndex++;
            }
