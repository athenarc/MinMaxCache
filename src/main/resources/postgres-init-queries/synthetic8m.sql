...
SELECT  timestamp, 'value_1', value_1 FROM more.synthetic8m_tmp;

INSERT INTO more.synthetic8m(epoch, timestamp, value, id, col)
SELECT  timestamp, 'value_2', value_2 FROM more.synthetic8m_tmp;

INSERT INTO more.synthetic8m(epoch, timestamp, value, id, col)
SELECT  timestamp, 'value_3', value_3 FROM more.synthetic8m_tmp;

INSERT INTO more.synthetic8m(epoch, timestamp, value, id, col)
SELECT  timestamp, 'value_4', value_4 FROM more.synthetic8m_tmp;

INSERT INTO more.synthetic8m(epoch, timestamp, value, id, col)
SELECT  timestamp, 'value_5', value_5 FROM more.synthetic8m_tmp;

DROP TABLE more.synthetic8m_tmp;

analyze more.manufacturing_exp;
create statistics s_ext_depend_synthetic8m(dependencies) on timestamp,id from more.synthetic8m ;
